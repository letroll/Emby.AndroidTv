...
public class BrowseViewFragment extends EnhancedBrowseFragment {
    ...
    protected void setupQueries(final IRowLoader rowLoader) {
        ...
        {
            case "movies":
                setupQueriesMovies(rowLoader);
                break;
            case "tvshows":
                setupQueriesTvShows(rowLoader);
                break;
            case "music":
                setupQueriesMusic(rowLoader);
                break;
            case "livetv":
                setupQueriesLiveTv(rowLoader);
                break;
            default:
                setupQueriesDefault(rowLoader);
                break;
        }
    }

    private void setupQueriesDefault(final IRowLoader rowLoader) {
    ...
    private void setupQueriesLiveTv(final IRowLoader rowLoader) {
        //On now
    ...
    private void setupQueriesMusic(IRowLoader rowLoader) {
        //Latest
    ...
    private void setupQueriesTvShows(IRowLoader rowLoader) {
    ...
    private void setupQueriesMovies(IRowLoader rowLoader) {
